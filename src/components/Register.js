...
const Register = () => {
  ...
  if(dataSend===true)
  {
    loadingAnimation = <div id="circularAnimation"><CircularProgress></CircularProgress></div>;
  }
  else
  {
    loadingAnimation = <Button className="button" variant="contained" onClick={(e)=>{validateInput(formData)}}>
    Register Now
   </Button>;
  }
